...
<body style="background: #bf00ff;padding:0;margin:0">
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#8000ff">
  <div style="background:#bf00ff;padding: 14px 3px;color:white;font-size: 15pt;text-align: center;text-shadow: 1px 1px 11px black">
  ...
  <div class="flex" style="padding: 3px 7px;margin:5px 2px;">
    ...
    <div style="color:#ffffff;font-size: 13pt;padding: 14px 7px;margin-left: 11px;"><?php echo ucfirst($user['name']); ?></div>
  </div>
  <div style="background: #00ffff;font-size: 10pt;padding: 11px;color: #000000">MAIN NAVIGATION</div>
  <div>
    <div style="background:#8000ff;color: white;padding: 13px 17px;border-left: 3px solid #ff0000;"><span><i class="fa fa-dashboard fa-fw"></i> Dashboard</span></div>
    <div class="item">
  ...
  <div style="background:#8000ff;color: white;padding: 13px 17px;border-left: 3px solid #ff0000;"><span><i class="fa fa-globe fa-fw"></i> Other Menu</span></div>
  <div class="item">
      <ul class="nostyle zero">
...
<div class="marginLeft" >
  <div style="color:white;background:#ff4d4d" >
...
<div class="account" style="display: none;">
  <div style="background: #ff4d4d;padding: 22px;" class="center">
